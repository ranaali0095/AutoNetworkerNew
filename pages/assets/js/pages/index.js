$(document).ready(function() {
    ...
    $('div[name=visitedDate]').daterangepicker({
            ranges: {
                'Today': [moment(), moment()],
        ...
        function(start, end) {
            $('div[name=visitedDate] span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        });
    $('div[name=connectedDate]').daterangepicker({
            ranges: {
                'Today': [moment(), moment()],
                'Yesterday': [moment().subtract('days', 1), moment().subtract('days', 1)],
                'Last 7 Days': [moment().subtract('days', 6), moment()],
        ...
        function(start, end) {
            $('div[name=connectedDate] span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        });
    /* ---------- Datable ---------- */
    $('.datatable').dataTable({
