...
function loadPage(e) {
    $.ajax({
        ...
        cache: !1,
        async: !1,
        beforeSend: function() { $.mainContent.css({ opacity: 0 }) },
        success: function() {
            Pace.restart();
...
if ($.ajaxLoad) {
    ...
    $(document).on("click", '.nav a[href!="#"]', function(e) {
        if ($(this).parent().parent().hasClass("nav-tabs") || $(this).parent().parent().hasClass("nav-pills")) e.preventDefault();
...
$(document).ready(function(e) {
    ...
    e(".nav-sidebar > li").hover(function() { e("body").hasClass("sidebar-minified") && e(this).addClass("opened hover") }, function() { e("body").hasClass("sidebar-minified") && e(this).removeClass("opened hover") });
    ...
    e("#match-content-oper").click(function() { ///adam poh
        var mainTag = document.getElementsByClassName("main")[0];
        var footerTag = document.getElementsByTagName("footer")[0];
        if (e("#match-content") && (document.getElementsByTagName("webview")[0])) {
            if (e("#match-content").css("display") == 'none') {
                e("#match-content").css("display", "block");
                mainTag.style.paddingRight = "420px";
                footerTag.style.paddingRight = "420px";
            } else {
                e("#match-content").css("display", "none");
...
$(document).on("click", ".panel-actions a", function(e) {
    e.preventDefault();
    if ($(this).hasClass("btn-close")) $(this).parent().parent().parent().fadeOut();
